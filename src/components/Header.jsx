    ...
    <header className="text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        />
          ...
          <div>
            <button className="cursor-pointer bg-myCyan hover:bg-myDarkCyan text-white px-4 py-2 rounded-full flex items-center space-x-2 transition-colors duration-300 ">
